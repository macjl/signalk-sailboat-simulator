...
function buildSchema () {
  return {
    ...
    description: 'Simulates a virtual sailboat from autopilot turn-rate output, polar performance, weather and optional shore-distance data already present in Signal K.',
    properties: {
      initialState: {
        type: 'object',
        title: 'Initial state',
