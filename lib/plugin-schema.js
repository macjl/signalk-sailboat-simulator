      ...
      weather: {
        ...
        properties: {
          ...
          providerId: {
            ...
            description: 'Leave empty to use the Signal K default weather provider.',
            default: ''
          },
          retryIntervalSeconds: {
            type: 'number',
            title: 'Weather retry interval in seconds',
            description: 'Retry interval used while no usable weather data is available.',
            default: 30,
            minimum: 5
          },
          pollIntervalSeconds: {
